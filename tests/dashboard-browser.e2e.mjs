...
async function fixture() {
  ...
  await json("graph-plan.json", { schema_version:"1.1",plan_id:"browser-plan",plan_version:1,status:"running",execution_profile:{mode:"standard",risk_level:"medium",integration_strategy:"dedicated",evidence_strategy:"separate"},capacity:{hard_limit:15,runtime_limit:8,permission_limit:6,effective_capacity:6},nodes,edges,terminal_outputs:["final-bundle"],summary:{agent_role_count:6,node_count:6,edge_count:6,task_count:6,planned_artifact_count:3,estimated_peak_agents:4,execution_shape:"hybrid",orchestration_profile:"standard"} });
